...
public partial class DictionaryPage : ContentPage
{
    ...
    private void MyList_ItemSelected(object sender, SelectedItemChangedEventArgs e)
    {
        ...
        TextToSpeech.Default.SpeakAsync($"In Arabic.", new SpeechOptions { Pitch = 0f, Volume = 1f , Locale= locales.FirstOrDefault(l => l.Language == "en-IE") });
        ...
        TextToSpeech.Default.SpeakAsync($". In English. {word.Eng}", new SpeechOptions { Pitch = 0f, Volume = 1f, Locale = locales.FirstOrDefault(l => l.Language == "en-IE") });
    }
}